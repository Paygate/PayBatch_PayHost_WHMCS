...
## PayGate PayBatch (with PayHost tokenization) plugin v1.0.9 for WHMCS v8.6.1
...
## Installation
Please navigate to the [releases page](https://github.com/PayGate/PayBatch_PayHost_WHMCS/releases), download the latest release (v1.0.9) and unzip. You will then be able to follow the integration guide which is included in the zip.
